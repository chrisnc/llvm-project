...
; RUN: llc -mtriple=armv6-eabi -mattr=+vfp2 %s -o - | FileCheck %s --check-prefixes=CHECK,ARMV6
; RUN: llc -mtriple=thumbv8.1m.main-arm-none-eabi -mattr=+dsp,+fp-armv8d16sp %s -o - | FileCheck %s --check-prefixes=CHECK,THUMB
